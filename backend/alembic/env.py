...
# Overwrite sqlalchemy.url with env var, ensuring asyncpg driver and removing invalid params
db_url_str = os.getenv("DATABASE_URL")
if db_url_str:
    url_obj = make_url(db_url_str)
    
    # Ensure usage of asyncpg
    if url_obj.drivername == "postgresql":
        url_obj = url_obj.set(drivername="postgresql+asyncpg")
    
    # Remove 'schema' query param if present (asyncpg doesn't support it)
